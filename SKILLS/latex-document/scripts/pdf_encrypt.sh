...
#
# Examples:
#   ./pdf_encrypt.sh document.pdf --user-password "<USER_PASSWORD>"
#   ./pdf_encrypt.sh document.pdf --user-password "<USER_PASSWORD>" --owner-password "<OWNER_PASSWORD>" --output secure.pdf
#   ./pdf_encrypt.sh document.pdf --user-password "<USER_PASSWORD>" --restrict-print --restrict-modify
...
Examples:
  $0 document.pdf --user-password "<USER_PASSWORD>"
  $0 document.pdf --user-password "<USER_PASSWORD>" --owner-password "<OWNER_PASSWORD>" --output secure.pdf
  $0 document.pdf --user-password "<USER_PASSWORD>" --restrict-print --restrict-modify
